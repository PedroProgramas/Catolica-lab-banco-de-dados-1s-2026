...
('J.R.R. Tolkien', 1902, 1973),
('Jane Austen', 1975, 2017),
('Machado de Assis', 1939, 1988),
('Agatha Christie', 1901, 1976),
('Isaac Asimov', 1920, 1992),
('Fyodor Dostoevsky', 1921, 1981),
...
(1,3,1,3,'Pride and Prejudice',1913,1),
(1,3,1,3,'Sense and Sensibility',1911,0),
(1,4,3,4,'Dom Casmurro',1999,1),
(1,4,3,4,'Memórias Póstumas de Brás Cubas',1981,0),
...
(1,7,1,6,'Crime and Punishment',1966,1),
(1,7,1,6,'The Brothers Karamazov',1980,0);
...
(2,3,1,3,'Emma',1915,0),
(2,4,3,4,'Quincas Borba',1991,1);

/** Usuário 3 */
INSERT INTO livro (id_usuario, id_autor, id_editora, id_categoria, titulo, ano_publicacao, lido) VALUES
(3,7,1,6,'Notes from Underground',1964,1),
(3,7,1,6,'The Idiot',1969,0),
...
(3,4,3,4,'Helena',1976,0),
(3,3,1,3,'Mansfield Park',1914,1);

/*Escreva uma query que retorna todos os livros da autora 'J.K. Rowling'*/
SELECT * FROM livro
WHERE autor = 'J.K. Rowling';

/*Escreva uma query que retorna todos os livros da categoria 'Filosofia'*/
SELECT * FROM livro
WHERE categoria = 'Filosofia';

/*Escreva uma query que altera o nome da categoria 'Filosofia' para 'Censurado'*/
UPDATE categoria
SET Filosofia = 'Censurado'
WHERE id = 6;

/*Escreva uma query que deleta todos os livros da categoria 'Censurado'*/
DELETE FROM livro
